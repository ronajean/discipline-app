        ...
        <main class="tracking-wide min-h-screen overflow-x-hidden text-indigo-800">
            ...
            <article class="grid grid-cols-6">
                <aside class="bg-indigo-800 text-white pb-10 relative">
                    <button class="hover:bg-amber-50 hover:text-amber-600 active:bg-amber-300 active:font-semibold flex flex-row items-center justify-center w-full p-4 mt-6 space-x-2" onclick="location.href='{{ route('odean.dashboard') }}'">
                        <svg class="h-6 w-6" viewBox="0 0 64 64" fill="currentColor">
                            <path fill-rule="evenodd" d="m56,34h-7v20h-12v-16h-10v16h-12v-20h-7v-4L32,6l9,9v-7h8v15l7,7v4Z" clip-rule="evenodd"></path>
                        </svg>
                        <p class="text-xs lg:text-base">Home</p>
                    </button>
                    <button class="text-amber-600 bg-amber-300 font-semibold flex flex-row items-center justify-center w-full p-4 mt-6 space-x-2">
                        <svg class="h-6 w-6" viewBox="0 0 64 64" fill="currentColor">
                    ...
                    <form action="/logout" method="POST">
                        @csrf
                        <button class="hover:bg-red-200 hover:text-red-600 active:bg-red-400 active:font-semibold flex flex-row items-center justify-center w-full p-4 space-x-2 mt-20">
                ...
                <div class="col-span-5 bg-white">
                    <header class="border-b border-indigo-800 p-6 pb-1.5 flex flex-row justify-between tracking-widest items-end">
                        ...
                        <div>
                            ...
                            <input id="searchInput" class="placeholder:text-indigo-300 focus:outline-none border border-indigo-300 focus:border-amber-400 text-xs tracking-widest w-full p-1.5" placeholder="Search students..." onkeypress="handleKeyPress(event)"/>
                    ...
                    <aside class="relative p-4 text-sm tracking-wider border-b border-indigo-800 pb-1.5 grid grid-cols-12 hover:bg-amber-50 active:bg-amber-200 cursor-pointer selection:bg-transparent">
                        ...
                        <div class="col-span-2"  id="studentInfo">
                            <p>Student Number</p>
                            <p>Student Name</p>
                            <p>College</p>
                            <p>Course</p>
                    ...
                    <article>
                        <form>
                            ...
                            <div class="flex justify-end m-20 mr-6">
                                <button class="p-2 shadow shadow-indigo-500 rounded-md hover:bg-amber-50 hover:shadow-amber-600 hover:text-amber-600 active:bg-amber-200 active:font-semibold" onclick="location.href='{{ route('odean.caserecord') }}'">
                                    <p>Add Case</p>
                                </button>
                            </div>
                        </form>
