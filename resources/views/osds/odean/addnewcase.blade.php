                    ...
                    <article>
                        <form>
                            ...
                            <div class="flex justify-end m-20 mr-6">
                                <button class="p-2 shadow shadow-indigo-500 rounded-md hover:bg-amber-50 hover:shadow-amber-600 hover:text-amber-600 active:bg-amber-200 active:font-semibold" onclick="location.href='osds-case-records.html'">
                                    <p>Add Case</p>
                                </button>
                            </div>
                        </form>
